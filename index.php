...
define('DEBUG_ON_LOCALHOST_OR_201TESTINGSERVER' , TRUE); //在本机测试或者在201测试服务器时为TRUE
...
define('ROOT_PATH','/cmbc');
if ( DEBUG_ON_LOCALHOST_OR_201TESTINGSERVER == TRUE) {
	define('HOST_URL', 'http://uat.zwmedia.com.cn');
	define ('RESOURCE_PATH', HOST_URL . ROOT_PATH );
	//define ('RESOURCE_PATH', 'http://cdn.zwmedia.com.cn');  //使用七牛CDN
	...
	define('HOST_URL', 'http://m.zwmedia.com.cn');
	//define ('RESOURCE_PATH', 'http://m.zwmedia.com.cn/wxzspfse');
	define ('RESOURCE_PATH', 'http://cdn.zwmedia.com.cn');  //使用七牛CDN
	define('WEB_URL', HOST_URL . ROOT_PATH . '/');
...
define('PRODUCT_RANK',false);  //true 开启针对个人的商品排名系统
